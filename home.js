...
var MAC={
    ...
    'Qrcode':{
        'Init':function(){
            $('.mac_qrcode').attr('src','//api.baidu.com/qrcode/index/w/150/h/150/url/' + MAC.Url);
        }
    },
    'Shorten': {
        'Init':function(){
        ...
        'Get':function(url,call){
            ...
            MAC.Ajax('//api.baidu.com/shorten/index/url/'+ encodeURIComponent(url),'get','jsonp','',function(r){
                if (r.code == 1) {
                    if($('.mac_shorten').length>0) {
